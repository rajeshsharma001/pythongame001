...
class paddle():
    ...
    def draw(self):
        pygame.draw.rect(screen, paddle_col, self.rect)           # fill shape
        pygame.draw.rect(screen, paddle_outline, self.rect, 3)    # shape outline
    ...
    def move(self):
        ...
        for row in wall.blocks:
            ...
            for item in row:
                ...
                if self.rect.colliderect(item[0]):  # here 0th index represents the rect in the individual_block[]
                    # check if the collision was from above 
                    #            ball            brick
                    if abs(self.rect.bottom - item[0].top) < collision_thresh and self.speed_y > 0:
                    # if abs(self.rect.bottom - item[0].top) < collision_thresh:
                        self.speed_y *= -1  # inverse the direction of the ball
                    ...
                    # if abs(self.rect.top - item[0].bottom) < collision_thresh :
                        self.speed_y *= -1   # inverse the direction of the ball
                        mixer.music.load("E:/Python Pygame/BreakOut/resources/move.mp3")
                        mixer.music.play()  
                    ...
                    # if abs(self.rect.right - item[0].left) < collision_thresh:
                        self.speed_x *= -1   # inverse the direction of the ball
                        mixer.music.load("E:/Python Pygame/BreakOut/resources/move.mp3")
                        mixer.music.play()  
                    ...
                    # if abs(self.rect.left - item[0].right) < collision_thresh:
                        self.speed_x *= -1   # inverse the direction of the ball
                        mixer.music.load("E:/Python Pygame/BreakOut/resources/move.mp3")
                        mixer.music.play()  
